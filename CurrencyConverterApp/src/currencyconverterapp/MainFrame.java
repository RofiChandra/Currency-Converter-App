...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Kurs EUR = 17.793");

        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("Kurs USD = 16.622");

        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("Kurs JPY = 151,11");
    ...
    private void btn_convertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_convertActionPerformed
		...
		float dollar = (float) (rupiah * 0.000060);
		float euro = (float) (rupiah * 0.000056);
		float yen = (float) (rupiah * 0.0066);

		float sisa1 = dollar - rupiah;
		float sisa2 = euro - rupiah;
		float sisa3 = yen - rupiah;
